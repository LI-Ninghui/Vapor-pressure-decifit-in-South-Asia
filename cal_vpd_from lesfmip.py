# -*- coding: utf-8 -*-
"""
Created on Tue Dec 23 10:00:28 2025
...
def process_forcing(forcing_name: str, data_dir: str | Path, models: list[str]) -> xr.Dataset:
    ...
    file_paths = {
        "tas": data_dir / f"mip_ensemble_{forcing_name}_tas.nc",
        "huss": data_dir / f"mip_ensemble_{forcing_name}_huss.nc",
        "ps": data_dir / f"mip_ensemble_{forcing_name}_ps.nc"
    }
    ...
    output_path = data_dir / f"mip_ensemble_{forcing_name}_vpd.nc"
...
if __name__ == "__main__":
    ...
    DATA_DIR = "E:/LUMIP_DAMIP_CMIP/merged_data"  # Replace with your actual data path
    
    FORCING_LIST = ["hist-aer", "hist-GHG", "historical", "hist-nat", "hist-noLu"]  # All forcing experiments "hist-nolu", 
    ...
    MODELS = [
            ...
            ] # Replace with your full model list

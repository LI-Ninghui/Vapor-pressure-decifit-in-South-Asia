# -*- coding: utf-8 -*-
"""
Created on Mon Dec 29 19:12:09 2025
...
def process_forcing(forcing_name: str, data_dir: str | Path, models: list[str]) -> xr.Dataset:
    ...
    file_paths = {
        "tas": data_dir / f"scemip_single_{forcing_name}_tas.nc",
        "huss": data_dir / f"scemip_single_{forcing_name}_huss.nc",
        "ps": data_dir / f"scemip_single_{forcing_name}_ps.nc"
    }
    ...
    output_path = data_dir / f"scemip_single_{forcing_name}_vpd.nc"
...
if __name__ == "__main__":
    ...
    FORCING_LIST = ["ssp126", "ssp245", "ssp370", "ssp585"] #, "ssp245", "ssp370", "ssp585"

# -*- coding: utf-8 -*-
"""
Created on Mon Dec 29 15:38:19 2025
...
experiments = ["ssp126", "ssp245", "ssp370", "ssp585"] #, "ssp245", "ssp370", "ssp585"

TARGET_START_YEAR = 2015  # Integer for robust year comparison
...
save_dir = r"E:/LUMIP_DAMIP_CMIP/merged_data"
...
for experiment in experiments:
    ...
    # ======================
    time_common = pd.date_range(start="2015-01-01", end="2099-12-31", freq="MS")
    ...
    ds_tas = xr.Dataset(
                        ...
                        attrs={
                            ...
                            "time_range": "2015-01-01 to 2099-12-31",
    ...
    # Define save path
    save_filename = f"scemip_single_{experiment}_tas.nc"
...
for experiment in experiments:
    ...
    # Define save path
    save_filename = f"scemip_single_{experiment}_huss.nc"
    save_path = os.path.join(save_dir, save_filename)
...
for model in models:
    for exp in experiments:
        ...
        # Store the processed and regridded ps data
...
for experiment in experiments:
    ...
    # Define save path
    save_filename = f"scemip_single_{experiment}_ps.nc"
    save_path = os.path.join(save_dir, save_filename)
